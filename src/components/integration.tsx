...
function OdooLogo() {
  return (
    <svg viewBox="0 0 24 24" fill="#a24689" className="w-full h-auto">
...
function JiraLogo() {
  return (
    <svg viewBox="0 0 24 24" fill="#2684FF" className="w-full h-auto">
...
function GitHubLogo() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-auto text-white">
...
export function Integration() {
  return (
    <SectionWrapper id="integration">
      <EyebrowBadge>Kein Rip-and-Replace</EyebrowBadge>
      <h2
      ...
      <div className="grid desktop:grid-cols-3 gap-5 mt-9">
        {integrations.map((item) => (
          <div
            key={item.title}
            className="bg-card border border-line rounded-card p-7 max-tablet:p-[22px] flex items-center gap-5"
          >
            <div className="w-[52px] h-[52px] shrink-0 grid place-items-center">
              {item.logo}
            </div>
            <div>
